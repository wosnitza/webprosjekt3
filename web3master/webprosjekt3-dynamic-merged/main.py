...
app.layout = dbc.Container(children=[
    ...
    dbc.Tabs(className='card-text', children=[
        # Tab for parameters - Should update other tabs with tables and charts
        dbc.Tab(id='Tab one', label="Parameters", labelClassName="menu",
            children=[
            dbc.Row([
            ...
            dbc.Row([
                dbc.Col(id="supplier", children=[
                    ...
                    dbc.Input(id="invoice-monthly", className="inputs",
                              type="number", placeholder="Monthly invoices"),
                    ...
                    dbc.Input(id="invoice-amount", type="number",
                    ...
                    html.Button("Generate chart", id="chart-generator"),
                ]),
        ...
        dbc.Tab(id="tab-two", label='Invoice table', labelClassName="menu", children=[
            dash_table.DataTable(id='table',
            style_as_list_view=True),
        ]),
        dbc.Tab(id="tab-three", labelClassName="menu", label="Accounting"),
...
# @app.callback(Output('nav-tabs', 'style'),[Input('chart-generator', 'n_clicks')])
